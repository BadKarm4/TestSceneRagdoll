    ...
    public partial class RagdollProcessor
    {
        ...
        void Initialization(MonoBehaviour caller, Transform objectWithAnimator, Transform customRagdollAnimator = null, Transform rootBone = null)
        {
            ...
            while (c != null)
            {
                if (c.rigidbody != null)
                {
                    ...
                    c.collisions = c.rigidbody.gameObject.AddComponent<RagdollCollisionHelper>().Initialize(this,c);
        ...
        internal void LateUpdate(bool captureAnimation = true)
        {
            ...
            while (c != null)
            {
                ...
                if (c == posingPelvis) {  c.visibleBone.rotation = Quaternion.LerpUnclamped(c.visibleBone.rotation, c.transform.rotation, blend); }
                else
        ...
        void UpdateReposing()
        {
            ...
            if (ReposeMode == EBaseTransformRepose.BonesBoundsBottomCenter)
            {
                ...
                if (RagdolledBlend < 0.9f) targetPosition = Vector3.LerpUnclamped(GetStoredHipsRootOffset(), targetPosition, RagdolledBlend);
            }
            ...
            if (RagdolledBlend < 0.9f)
            {
                targetPosition = Vector3.LerpUnclamped(BaseTransform.position, targetPosition, RagdolledBlend);
            }
