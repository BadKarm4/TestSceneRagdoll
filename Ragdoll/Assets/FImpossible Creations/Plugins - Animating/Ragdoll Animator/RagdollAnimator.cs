...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public class RagdollAnimator : MonoBehaviour
    {
        ...
        public void User_ChangeBlendOnCollisionAndRestore(bool v1, float v2)
        {
            StartCoroutine(IEChangeBlendOnCollAndRestore(v1, v2));
        }
        IEnumerator IEChangeBlendOnCollAndRestore(bool v1, float v2)
        {
            bool toRestore = Parameters.BlendOnCollision;
            Parameters.BlendOnCollision = v1;
        ...
        /// <param name="duration"> Time in seconds </param>
        public void User_SetPhysicalTorque(Vector3 rotationPower, float duration)
        {
            StartCoroutine(Processor.User_SetPhysicalTorque(rotationPower, duration));
        }
        ...
        public void User_GetUpStackV2( float targetRagdollBlend = 0f, float targetMusclesPower = 0.85f, float duration = 1.1f)
        {
            ...
            User_OverrideRagdollStateWithCurrentAnimationState();
            Parameters._User_GetUpResetProbe();
        }
